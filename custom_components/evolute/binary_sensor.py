...
BINARY_SENSORS: tuple[_Desc, ...] = (
    ...
    _Desc(key="ready", data_key="ready", name="Готовность",
          device_class=BinarySensorDeviceClass.PLUG, icon="mdi:car-electric"),
    ...
    _Desc(key="prepare_running", data_key="preparation_scriptIsRunning",
